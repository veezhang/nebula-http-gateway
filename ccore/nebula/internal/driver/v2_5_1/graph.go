...
import (
	...
	graph2_5_1 "github.com/vesoft-inc/nebula-http-gateway/ccore/nebula/internal/thrift/v2_5_1/graph"
...
type (
	defaultGraphClient struct {
		graph *graph2_5_1.GraphServiceClient
	}

	authResponse struct {
		*graph2_5_1.AuthResponse
	}

	executionResponse struct {
		*graph2_5_1.ExecutionResponse
	}
)
...
func newGraphClient(transport thrift.Transport, pf thrift.ProtocolFactory) types.GraphClientDriver {
	return &defaultGraphClient{
		graph: graph2_5_1.NewGraphServiceClientFactory(transport, pf),
	}
}
